...
def display_repos(df): 
    ...
    x=datetime.date.fromisoformat('2021-01-01')+ pd.DateOffset(months=-1) # for debug
...
def linkedin_request(send_textfile): # makes a request to LinkedIn API
    linkedin_access_token=sys.argv[5]
    id_urn=sys.argv[6]
    data = {
...
def send_email(send_textfile): #sends a email to myself
  try:
